-- Migration: Fix Timezone in Audit Message
-- Date: 2026-02-17
-- Objective: Fix the audit message to use the academy's timezone instead of UTC.
...
BEGIN
    ...
    LOOP
        ...
        INSERT INTO transactions (
            ...
            'Reversión por cambio de fecha clase del ' || TO_CHAR(OLD.scheduled_at AT TIME ZONE academy_tz, 'DD/MM/YYYY HH24:MI') || 'hs al ' || TO_CHAR(NEW.scheduled_at AT TIME ZONE academy_tz, 'DD/MM/YYYY HH24:MI') || 'hs',
